...
if 'importlib' in globals():
  npplib_spec = importlib.util.spec_from_loader('npplib', importlib.machinery.SourceFileLoader('npplib', SOURCE_DIR + '/tacklebar/scripts/libs/npplib.py'))
  npplib = importlib.util.module_from_spec(npplib_spec)
  npplib_spec.loader.exec_module(npplib)
else:
  npplib = imp.load_source('npplib', SOURCE_DIR + '/tacklebar/scripts/libs/npplib.py')
